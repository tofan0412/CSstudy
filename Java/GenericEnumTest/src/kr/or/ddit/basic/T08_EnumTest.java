...
public class T08_EnumTest {
	...
	// 데이터 값을 임의로 지정한 열거형 객체의 선언
	// 데이터값을 정해 줄 경우에는 생성자를 만들어서 괄호 속의 값이 변수에
	// 저장되도록 해야 한다. 
	public enum Season { 
	...
	public static void main(String[] args) {
		...
		System.out.println("myCity2 : " + myCity2.name());	//.name 없으면 자동으로 객체에 대해 override된 toString을 사용한다. 
