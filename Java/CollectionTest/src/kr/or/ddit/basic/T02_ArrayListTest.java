...
//    List list1 = new Vector();	//리스트는 벡터로 받아도 된다.
      ...
      String[] strArr2 = list2.toArray(new String[0]);	//원하는 형태의 객체를 생성해서 넣어준다.
      ...
      */
      ...
      // 모두 삭제하지 못하고 2개가 남았다. 삭제할 때 내부적으로 당겨온다. 하나 지우고 땡기고, 하나 지우고 땡기고, 하나 지우고 땡기고...
      // 
